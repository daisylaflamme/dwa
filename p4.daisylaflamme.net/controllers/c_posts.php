...
public function unfollow($user_id_followed) {
	...
	public function p_add() {
		...
		# Send the following data back to JS
		echo "Your post has been added! <br>Its ID is ".$new_post_id."<br>";
		echo "This post was created on ".Time::display(Time::now());
		echo "<br><br>Your post:<br>".$_POST['content'];	

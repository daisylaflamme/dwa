...
var RegisterForm = function () {
    ...
    this.fields["email"].message = "Valid email";
    this.fields["password"].message = "Must be at least 4 characters.";
	...
	this.fields["link"].required = "Website link is required.";
    this.fields["mission"].required = "Mission statement is required.";
	this.fields["vision"].required = "Vision is required.";
    this.fields["program"].required = "Active fundracing is required.";
}
